...
constexpr float    LF_KP_STRAIGHT     = 0.0650f;
constexpr float    LF_KD_STRAIGHT     = 0.200f;

constexpr float    LF_KP_CURVE        = 0.1500f;
constexpr float    LF_KD_CURVE        = 0.1000f;
...
constexpr float    LF_SPEED_REDUCTION = 0.35f; // [motor_cmd / error_unit]

constexpr int16_t  LF_CURVE_THRESHOLD = 800;   // [error_units]
constexpr int16_t  LF_CURVE_HYST      = 200;    // [error_units]
...
constexpr int16_t  LF_CALIBRATION_SPEED   = 50;   // [motor_cmd]
