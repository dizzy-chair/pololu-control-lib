...
constexpr float    LF_KP_CURVE        = 0.20f;
constexpr float    LF_KD_CURVE        = 0.3f;
...
constexpr float    LF_SPEED_REDUCTION = 0.2f; // [motor_cmd / error_unit]

constexpr int16_t  LF_CURVE_THRESHOLD = 600;   // [error_units]
constexpr int16_t  LF_CURVE_HYST      = 50;    // [error_units]
